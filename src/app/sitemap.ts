...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/logistics`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
    { url: `${baseUrl}/logistics/details`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/distribution`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
    ...
    { url: `${baseUrl}/csr/details`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
